...
listener, Bun child, or window. `keld-core` accepts one primary Authenticode signature,
derives publisher scope from the verified leaf certificate's SPKI, and reads the
