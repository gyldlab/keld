...
| Claim | Now |
|---|---|
| "Keld first-paints 1.87x slower than Tauri" | **Retired.** 573 vs 589 ms is a statistical tie on the identical engine. The published gap was the bounds defect plus harness spawn overhead, both fixed. |
