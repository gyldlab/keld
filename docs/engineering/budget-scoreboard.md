...
| **First paint** | Time from launch until the harness observes a double-rAF paint opportunity. It is a proxy, not compositor completion or display scanout. Lower generally means the app feels visible sooner. |
