...
- 2026-08-14 [ipc] kipc v2 HELLO carries a 32-byte session token from `KELD_APP_LINK` (`<endpoint>#<64 hex>`); empty/foreign HELLO is `KELD-IPC-007`. Windows named-pipe DACL is not this slice. (evidence: KEL-60, crates/keld-ipc/src/token.rs)
